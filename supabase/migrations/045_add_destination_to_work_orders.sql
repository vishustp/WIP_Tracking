-- Migration 045: Add Destination field to work_orders table and update import_work_orders_batch RPC
-- Destination data will come from Excel file column named 'Destination-2' (or Destination)
-- and be used in Process Sheet (F-11) Destination field.

alter table public.work_orders
  add column if not exists destination text;

-- Update import_work_orders_batch RPC to handle destination column
