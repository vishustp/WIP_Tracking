-- ======================================================================================
-- 019: DIRECT STAGE-TO-STAGE WORK ORDER WIP VIEW & PRODUCTION ENTRY QUEUE (v3)
-- ======================================================================================
...
--    - Upstream of Band Saw: Mother / Drawn Long Pipes (HT Nos) with actual physical elongated length
