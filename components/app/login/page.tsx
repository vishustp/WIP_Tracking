    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-5xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded-xl border border-blue-500/30 bg-blue-950/40 p-3.5 text-sm space-y-1.5 backdrop-blur-xs">
          ...
          <div className="rounded-xl border border-purple-500/30 bg-purple-950/40 p-3.5 text-sm space-y-1.5 backdrop-blur-xs">
          ...
          <div className="rounded-xl border border-amber-500/30 bg-amber-950/40 p-3.5 text-sm space-y-1.5 backdrop-blur-xs">
        ...
        {activeUser && (
          <div className="rounded-2xl border border-emerald-500/30 bg-emerald-950/30 p-4 backdrop-blur-md flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl">
            <div className="flex items-center gap-3 text-left">
              ...
              <div>
                <div className="text-sm text-emerald-300 font-medium">Currently active session:</div>
                <div className="text-sm font-bold text-white flex items-center gap-2">
                  {activeUser.name}
                  <span className="text-xs px-2.5 py-1 rounded-full bg-emerald-500/30 text-emerald-200 border border-emerald-400/30 font-semibold uppercase">
                ...
                <div className="text-sm text-slate-400">{activeUser.department}</div>
              </div>
            </div>
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-emerald-900/30 hover:bg-emerald-500 transition-all cursor-pointer whitespace-nowrap"
            >
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-start justify-between gap-2 mb-2.5">
                        ...
                        {isCurrent ? (
                          <span className="inline-flex items-center gap-1 text-xs font-semibold text-emerald-400 bg-emerald-950/80 px-2.5 py-1 rounded-full border border-emerald-500/40">
                      ...
                      <div className="my-2.5 p-2.5 rounded-xl bg-slate-900/90 border border-slate-800/80 text-sm space-y-1.5">
                    ...
                    {/* Button Action */}
                    <div className="pt-2 border-t border-slate-800/80 flex items-center justify-between text-sm font-semibold text-blue-400 group-hover:text-blue-300">
        ...
        {activeTab === 'custom' && (
          <div className="max-w-md mx-auto rounded-2xl border border-slate-800 bg-slate-950/80 p-6 sm:p-8 shadow-2xl backdrop-blur-xl space-y-5">
            ...
            <form onSubmit={handleCustomSubmit} className="space-y-4 text-sm">
              <div>
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 hover:bg-blue-500 font-semibold text-white transition-colors py-2.5 text-sm rounded-xl"
              >
