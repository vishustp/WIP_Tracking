    ...
    <div className="space-y-4 max-w-4xl">
      ...
      <form onSubmit={submit} className="space-y-4 rounded-xl border border-slate-200 bg-white p-5 shadow-xs">
        <div className="flex items-center justify-between">
          ...
          {!canSubmit && (
            <span className="inline-flex items-center gap-1 text-sm font-semibold text-amber-800 bg-amber-100 border border-amber-300 rounded-md px-2.5 py-1">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div>
            <label className="mb-1 block text-sm font-semibold text-slate-700">Source Work Order</label>
          ...
          <div>
            <label className="mb-1 block text-sm font-semibold text-slate-700">Target Work Order</label>
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50/70 p-3">
            <div className="text-sm text-slate-500 font-medium">Available for Diversion</div>
          ...
          <div>
            <label className="mb-1 block text-sm font-semibold text-slate-700">Applicable Route</label>
          ...
          <div>
            <label className="mb-1 block text-sm font-semibold text-slate-700">Diversion Date</label>
            <Input type="date" value={date} onChange={(e) => setDate(e.target.value)} required disabled={!canSubmit} />
          </div>

          <div>
            <label className="mb-1 block text-sm font-semibold text-slate-700">Multiple</label>
            <Input
              type="number"
              min="0.001"
              step="0.001"
          ...
          <div className="md:col-span-2">
            <label className="mb-1 block text-sm font-semibold text-slate-700">Reason / Justification</label>
            <Textarea
              className="min-h-20"
              value={reason}
