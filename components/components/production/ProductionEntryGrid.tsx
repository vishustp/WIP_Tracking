                    ...
                    <tr key={key} className="hover:bg-slate-50/50 transition-colors group">
                      ...
                      {(stage === "HEAT_TREATMENT" || stage === "HOLLOW_HEAT_TREATMENT") && (
                        <td className="py-3 px-3 align-top">
                          <input
                            ...
                            className="w-36 rounded-lg border-2 border-slate-300 bg-white px-3 py-2.5 text-base font-medium text-slate-900 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/25 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed"
                          />
                        </td>
                      )}
                      ...
                      <td className="py-3 px-3 align-top">
                        <input
                          ...
                          className="w-44 rounded-lg border-2 border-slate-300 bg-white px-3 py-2.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/25 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed"
                        />
                      </td>
                    </tr>
                  );
