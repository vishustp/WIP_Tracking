        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-2xl rounded-xl border bg-background p-5 shadow-xl">
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              ...
              <label className="text-sm font-medium">Production PCS<input type="text" inputMode="decimal" className="mt-1 h-10 w-full rounded-md border px-3" value={editPcs} onChange={(e) => { const value = e.target.value; setEditPcs(value); setEditMtr(value === "" ? "" : String(mtrFromPcs(n(value), n(editing.avg_length)))); }} /></label>
              <label className="text-sm font-medium">Production MTR <span className="font-normal text-muted-foreground">(editable)</span><input type="text" inputMode="decimal" className="mt-1 h-10 w-full rounded-md border px-3" value={editMtr} onChange={(e) => setEditMtr(e.target.value)} /><span className="text-[11px] text-muted-foreground">Calculated from PCS: {fmt(mtrFromPcs(n(editPcs), n(editing.avg_length)), " MTR")}</span></label>
