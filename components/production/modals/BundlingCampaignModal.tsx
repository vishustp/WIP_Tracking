  ...
  return (
    ...
    >
      <div className="flex flex-col">
                ...
                <div className="p-3">
                        ...
                        <tr key={b.id} className="hover:bg-slate-50/60">
                          ...
                          <td className="px-3 py-2 text-center">
                            <button
                              ...
                              className="p-2 sm:p-1.5 min-w-[32px] min-h-[32px] inline-flex items-center justify-center rounded text-rose-500 hover:bg-rose-50 hover:text-rose-700 cursor-pointer transition-colors"
                            >
                              <Trash2 size={15} />
                            </button>
                          </td>
                  ...
                  <div className="mt-2.5 flex items-center justify-between">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-lg border border-dashed border-teal-500 bg-teal-50/50 hover:bg-teal-100 text-teal-800 font-bold px-3.5 py-2 min-h-[38px] text-xs cursor-pointer transition-colors shadow-2xs active:scale-[0.98]"
                    >
        ...
        {/* Modal Footer */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-t border-slate-200 bg-slate-50 px-6 py-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
            ...
            <Button
              ...
              variant="teal"
              size="md"
              className="min-h-[40px] px-4 text-xs font-bold"
              onClick={onApplyToGrid}
              disabled={saving || totalEnteredPcs <= 0}
            >
              <CheckCircle2 size={14} />
              Apply to Grid ({totalBundleCount} Bundles)
            </Button>
            <Button
              type="button"
              variant="primary"
