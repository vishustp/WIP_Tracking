      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-4 border-b border-slate-100">
            ...
            {!canSubmit && (
              <span className="inline-flex items-center gap-1 text-xs font-semibold text-amber-800 bg-amber-100 border border-amber-300 rounded-md px-2.5 py-1">
          ...
          {source && sourceWip && (
            <div className="rounded-xl border-2 border-indigo-100 bg-gradient-to-br from-indigo-50/60 via-slate-50/40 to-white p-5 space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-2 border-b border-indigo-100 pb-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1 rounded-md bg-indigo-100 px-2.5 py-0.5 text-xs font-bold text-indigo-800 font-mono">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs bg-white/80 p-3 rounded-lg border border-indigo-100/70">
                <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="rounded-xl border border-indigo-200 bg-white p-4 shadow-2xs relative overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="rounded-md bg-indigo-600 text-white text-[10px] font-bold px-2 py-0.5">
                      Ready to Divert
                    </span>
                  </div>
                  <div className="mt-2">
                    ...
                    <span className="text-xs font-semibold text-indigo-700 ml-1.5">Mtrs</span>
                  </div>
                  <div className="mt-1 flex items-center gap-3 text-xs text-slate-600 font-mono">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-2xs">
                  ...
                  <div className="mt-2">
                    ...
                    <span className="text-xs font-semibold text-slate-500 ml-1.5">Mtrs</span>
                  </div>
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-2xs">
                  ...
                  <div className="mt-2">
                    ...
                    <span className="text-xs font-semibold text-amber-700 ml-1.5">Mtrs</span>
                  </div>
                  <div className="mt-1 text-xs text-slate-500 font-mono">
                ...
                <div className="bg-white/90 p-3 rounded-lg border border-slate-200/80">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {sourceWip.stageBreakdown.map((stg: any, idx: number) => (
                      <div
                        key={idx}
                        className="inline-flex items-center gap-2 rounded-lg bg-slate-50 border border-slate-200 px-3 py-1.5 text-xs font-mono"
                      >
          ...
          {source && target && (
            <div className="rounded-xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50/50 via-slate-50/30 to-white p-5 space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-2 border-b border-emerald-100 pb-3">
                ...
                {isExceeding ? (
                  <span className="inline-flex items-center gap-1 rounded-md bg-red-100 px-2.5 py-0.5 text-xs font-bold text-red-800">
              ...
              <div className="rounded-lg bg-emerald-100/50 p-3 border border-emerald-200/70 text-xs text-emerald-900 flex items-start gap-2">
