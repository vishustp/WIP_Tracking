  ...
  return (
    <div className="mx-auto max-w-3xl py-12 px-4">
      <div className="rounded-2xl border border-amber-200 bg-white p-8 shadow-sm text-center">
        ...
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-amber-100 text-amber-800 border border-amber-300 mb-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 text-xs text-slate-600 max-w-lg mx-auto mb-8 text-left space-y-2">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Button
            ...
            className="bg-slate-900 text-white hover:bg-slate-800 inline-flex items-center gap-2 text-xs py-2 px-4"
          >
          ...
          <Button
            ...
            className="bg-white border border-slate-300 text-slate-700 hover:bg-slate-100 inline-flex items-center gap-2 text-xs py-2 px-4"
          >
