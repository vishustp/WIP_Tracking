      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-rose-200 bg-rose-50 px-3.5 py-2 text-xs font-semibold text-rose-700 shadow-xs hover:bg-rose-100 transition-colors cursor-pointer"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-5 border-t border-slate-100 text-xs">
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-100">
            <div className="text-[11px] font-medium text-slate-500">Active Operators & Staff</div>
            <div className="text-lg font-bold text-slate-900 mt-0.5 font-mono">
              {users.filter(u => u.active).length} <span className="text-xs font-normal text-slate-400">/ {users.length}</span>
            </div>
          </div>
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-100">
            <div className="text-[11px] font-medium text-slate-500">Process Routes Master</div>
            <div className="text-lg font-bold text-slate-900 mt-0.5 font-mono">
              {routes.filter(r => r.active).length} <span className="text-xs font-normal text-slate-400">Active</span>
            </div>
          </div>
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-100">
            <div className="text-[11px] font-medium text-slate-500">Shop Floor Stages</div>
            <div className="text-lg font-bold text-slate-900 mt-0.5 font-mono">
              {stages.length} <span className="text-xs font-normal text-slate-400">Work Centers</span>
            </div>
          </div>
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-100">
            <div className="text-[11px] font-medium text-slate-500">Audit Compliance Logs</div>
            <div className="text-lg font-bold text-slate-900 mt-0.5 font-mono">
              {auditLogs.length} <span className="text-xs font-normal text-slate-400">Records</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={openAddUser}
              className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-blue-600 px-4 py-2 text-xs font-semibold text-white shadow-xs hover:bg-blue-500 transition-colors cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <span className="text-xs text-slate-400">{routes.length} standard routes</span>
              </div>
                  ...
                  <div key={route.id} className="py-3 flex items-center justify-between">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-slate-900 text-xs font-mono">{route.route_code}</span>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <span className="text-xs text-slate-400">{stages.length} work centers</span>
              </div>
                ...
                {stages.map((stage, idx) => (
                  <div key={stage.id} className="py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-slate-900 text-xs">{stage.stage_name}</div>
                        <div className="text-[10px] text-slate-500 font-mono">{stage.stage_code}</div>
                      </div>
                    </div>
            ...
            <div className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  <p className="text-[11px] text-slate-400 mt-1">Default 100%. Set to 105% to allow 5% yield over-rolling buffer.</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-300 px-3 py-2 text-xs font-mono focus:border-blue-500 focus:outline-hidden"
                  />
                  <p className="text-[11px] text-slate-400 mt-1">Standard 7.85 for carbon & alloy seamless pipe calculation.</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-300 px-3 py-2 text-xs font-mono focus:border-blue-500 focus:outline-hidden"
                  />
                  <p className="text-[11px] text-slate-400 mt-1">Flag scrap rejection exceeding 5% in single shift.</p>
                </div>
              ...
              <div className="pt-4 border-t border-slate-100 flex justify-end">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-5 py-2 text-xs font-semibold text-white shadow-xs hover:bg-slate-800 transition-colors cursor-pointer"
                >
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 shadow-xs hover:bg-slate-50 transition-colors cursor-pointer"
            >
              <Download className="h-3.5 w-3.5 text-slate-500" />
                    ...
                    filteredAuditLogs.map((log) => (
                      <tr key={log.id} className="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td className="py-3 px-4 font-semibold text-slate-900">
                          ...
                          <div className="text-[10px] text-slate-400 font-mono font-normal">{log.user_email}</div>
                        </td>
                        <td className="py-3 px-4">
                          <span className="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-semibold bg-slate-100 text-slate-700 font-mono">
                            {log.action_type}
                          </span>
                        </td>
          ...
          <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl border border-slate-200 animate-in fade-in zoom-in-95">
            ...
            <form onSubmit={handleSaveUser} className="space-y-4 mt-4 text-xs">
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg bg-blue-600 text-xs font-semibold text-white hover:bg-blue-500 shadow-xs transition"
                >
