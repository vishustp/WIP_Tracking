    ...
    <div className="space-y-6 max-w-6xl mx-auto pb-12">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs">
          ...
          <div className="flex items-center gap-2">
            {isAdmin ? (
              <button
                ...
                onClick={handleSave}
                disabled={saving}
                className="inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2 text-xs font-semibold text-white shadow-xs hover:bg-slate-800 transition-colors cursor-pointer disabled:opacity-50"
              >
                <Save className="h-3.5 w-3.5" />
                {saving ? 'Saving...' : 'Save Profile'}
              </button>
            ) : (
              <div className="inline-flex items-center gap-1.5 rounded-lg bg-slate-100 border border-slate-200 px-3.5 py-2 text-xs font-semibold text-slate-500">
        ...
        {isAdmin ? (
          ...
          <div className="mt-5 pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3 text-xs bg-slate-50/80 p-3 rounded-xl border border-slate-200">
            <div className="flex items-center gap-2 text-slate-600 font-medium">
              <Lock className="h-4 w-4 text-slate-500" />
              <span>User Profile Management: <strong>Restricted to Admin Accounts</strong></span>
            </div>
            <span className="text-[11px] text-slate-500">Only Administrator can alter department assignments or credentials.</span>
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs space-y-4">
            ...
            {!isAdmin && (
              <div className="rounded-lg bg-amber-50/80 border border-amber-200 p-3 text-xs text-amber-900 flex items-start gap-2.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-lg border px-3 py-2 text-xs focus:border-blue-500 focus:outline-hidden ${
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              ...
              <span className="text-[11px] text-slate-400">4-Digit Terminal Auth</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                ...
                <input
                  ...
                  disabled
                  value={pin}
                  className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-600 tracking-widest font-mono"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-lg border px-3 py-2 text-xs tracking-widest font-mono focus:border-blue-500 focus:outline-hidden ${
            ...
            <div className="space-y-2.5 text-xs">
              <label className="flex items-center justify-between p-2.5 rounded-lg border border-slate-100 hover:bg-slate-50 cursor-pointer">
                <div>
                  ...
                  <div className="text-[11px] text-slate-500">Notify when any stage exceeds critical WIP capacity limit</div>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between p-2.5 rounded-lg border border-slate-100 hover:bg-slate-50 cursor-pointer">
                <div>
                  ...
                  <div className="text-[11px] text-slate-500">Flag work orders exceeding scrap threshold in rolling or draw</div>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between p-2.5 rounded-lg border border-slate-100 hover:bg-slate-50 cursor-pointer">
                <div>
                  ...
                  <div className="text-[11px] text-slate-500">Highlight pending orders due within 7 days</div>
                </div>
                <input
                  type="checkbox"
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs space-y-4">
            ...
            <div>
              <div className="text-xs font-semibold text-slate-800 mb-1">{roleInfo.label}</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs space-y-3">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              ...
              <span className="text-[10px] text-slate-400">{userLogs.length} events</span>
            </div>
              ...
              <div className="space-y-2.5 max-h-72 overflow-y-auto pr-1">
                {userLogs.slice(0, 6).map((log) => (
                  <div key={log.id} className="p-2.5 rounded-lg bg-slate-50 border border-slate-100 text-xs">
                    ...
                    <p className="text-[11px] text-slate-700 leading-snug">{log.details}</p>
                  </div>
                ))}
              </div>
            )}
