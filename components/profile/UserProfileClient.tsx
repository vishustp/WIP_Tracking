        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              ...
              <span className="text-[11px] text-slate-400">Plant Shop Floor Credentials</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div className="sm:col-span-2">
                ...
                <p className="text-[11px] text-slate-400 mt-1">
                  When you open the Production Entry screen, this stage will be selected by default.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-300 px-3 py-2 text-xs tracking-widest font-mono focus:border-blue-500 focus:outline-hidden"
                />
              </div>
            </div>
          </div>
